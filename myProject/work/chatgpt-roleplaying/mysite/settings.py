...
SECRET_KEY = "django-insecure-z%6c31f4hcvfgc337c37i(u^pmc*nv#wplu#eqf^-=yb9%hjud"
...
ASGI_APPLICATION = "mysite.asgi.application"    # 비동기적
...
# LANGUAGE_CODE = "en-us"
LANGUAGE_CODE = env.str("LANGUAGE_CODE", default="en-us") # env에 language code가 있으면 그걸로, 없으면 디폴트값(영어로)
