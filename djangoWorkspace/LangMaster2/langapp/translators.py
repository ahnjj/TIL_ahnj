...
def google_translate(
    text: str,
    source: Literal["auto", "en", "ko"],    # 받을 type지정
    target: Literal["en", "ko","ja","fr","zh", "es", "de", "ru"],
) -> str:
    ...
    # Android 디바이스의 User-Agent를 흉내냅니다.
    headers = {
        "User-Agent": (
    ...
    translated_text = bs_obj.select_one(".result-container").text.strip()
